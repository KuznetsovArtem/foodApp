...
gulp.task('watch', function () {
  ...
  gulp.watch(['./app/scripts/components/templatesCache/templatescache.jss'], ['crutch']);
});
...
gulp.task('crutch', function () {
  return gulp.src(['./app/scripts/components/templatesCache/templatescache.jss'])
    .pipe(connect.reload());
});
